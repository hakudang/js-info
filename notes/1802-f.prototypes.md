# F.prototype
F là constructor function
Khi bạn định nghĩa một constructor function JavaScript, hàm đó tự động nhận được một thuộc tính đặc biệt gọi là `prototype`. Thuộc tính này trả về một object, nó được sử dụng để thiết lập `[[Prototype]]` cho các object mới được tạo ra với từ khóa `new`.
...
flowchart LR
    ...
    subgraph Prototypes
        ...
        D[Object.prototype<br/>constructor: Object]
    end

    subgraph Instance
        C[ rabbit<br/>name: 'White Rabbit' ]
    end

    A --prototype--> B
    B --[[Prototype]]--> D
    C --[[Prototype]]<br/>tự động --> B
```
